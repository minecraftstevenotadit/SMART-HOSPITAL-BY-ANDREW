...
st.markdown("""
 <style>
        ...
        div.stButton>button {
            ...
            padding: 0.75ren 2rem !important;
    ...
    st.markdown("""
     <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#7c2d12;">What is your temperature and heart beat rate?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
